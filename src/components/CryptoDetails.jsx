...
const CryptoDetails = () => {
    ...
    const stats = [
        ...
        { title: 'Market Cap', value: `$ ${cryptoDetails?.marketCap && millify(cryptoDetails?.marketCap)}`, icon: <TrophyOutlined />},
        { title: 'All-time-high(daily avg.', value: `$ ${cryptoDetails?.allTimeHigh?.price && millify(cryptoDetails?.allTimeHigh?.price)}`, icon: <ThunderboltOutlined />},
    ];
    ...
    const genericStats = [
        ...
        { title: 'Total Supply', valiue: `$ ${cryptoDetails?.supply.total && millify(cryptoDetails?.supply?.total)}`, icon: <ExclamationCircleOutlined />},
